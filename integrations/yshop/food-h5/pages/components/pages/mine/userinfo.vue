<template>
	...
	<view class="userinfo-page d-flex flex-column">
		<view class="flex-fill userinfo-page__form">
			<list-cell :hover="false">
				...
				<view class="userinfo-page__avatar-row d-flex align-items-center">
								...
								<view v-if="!member.avatar && !IS_MINIPAY_FOOD" class="flex-1 userinfo-page__change-avatar">
			...
			<list-cell :hover="false">
				<view class="userinfo-page__field w-100 d-flex align-items-center">
					...
					<view class="userinfo-page__input flex-fill">
						...
						v-model="member.nickname" :disabled="IS_MINIPAY_FOOD">
					</view>
				</view>
			</list-cell>
			<list-cell :hover="false">
		...
		<view v-if="IS_MINIPAY_FOOD" class="text-color-assist font-size-sm mt-2">
			昵称、头像和账号手机号由 MiniPay 统一管理，请在 MiniPay 个人资料或账号安全中修改。
		</view>
		<view v-else class="userinfo-page__actions d-flex align-items-center just-content-center">
...
import { VUE_APP_UPLOAD_URL, IS_MINIPAY_FOOD } from '@/config';
